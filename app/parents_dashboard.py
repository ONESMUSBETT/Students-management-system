...
from models import Parents,Students,session
import dialog
from PyQt5.QtWidgets import QApplication, QMainWindow
class Ui_Form(QMainWindow,object):
    def search_(self):
        parents = session.query(Parents).filter_by(children=self.search.text().upper()).all()
        if len(parents)>0:
            for i, student in enumerate(parents):
                ...
                self.tableWidget.setItem(i, 2, QtWidgets.QTableWidgetItem(student.children))
...
"background-color: rgb(255, 85, 0);")
    ...
    def retranslateUi(self, Form):
        ...
        item.setText(_translate("Form", "Student Adm"))
        ...
        for i, parent in enumerate(parents):
            ...
            self.tableWidget.setItem(i, 0, QtWidgets.QTableWidgetItem(parent.full_name))
            self.tableWidget.setItem(i, 1, QtWidgets.QTableWidgetItem(parent.contacts))
            self.tableWidget.setItem(i, 2, QtWidgets.QTableWidgetItem(parent.children))
            self.tableWidget.setItem(i, 3, QtWidgets.QTableWidgetItem(parent.location))
